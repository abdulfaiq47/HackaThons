...
class ModernStudentManagementUI:
    ...
    def setup_page(self):
        ...
        # Purple Theme CSS to match the PHP system
        st.markdown("""
        <style>
    ...
    def show_main_dashboard(self):
        # Display the three main buttons as in the PHP system
        st.markdown("""
        ...
        if stats:
            ...
            with col1:
                st.markdown(f"""
                <div class="card">
                    <div style="font-size: 24px; font-weight: bold; color: #6A1B9A;">{stats['total_students']}</div>
            ...
            with col2:
                st.markdown(f"""
                <div class="card">
                    <div style="font-size: 24px; font-weight: bold; color: #6A1B9A;">{stats['average_performance']}%</div>
            ...
            with col3:
                st.markdown(f"""
                <div class="card">
                    <div style="font-size: 24px; font-weight: bold; color: #6A1B9A;">{stats['average_attendance']}%</div>
    ...
    def show_advanced_analytics(self):
        ...
        with col3:
            st.markdown(f"""
            <div class="card">
                <div style="font-size: 24px; font-weight: bold; color: #6A1B9A;">{performance_analysis.get('pass_rate', 0):.1f}%</div>
                <div>Pass Rate</div>
            </div>
            """, unsafe_allow_html=True)
